...
Chapter~\ref{cha:fundamentals_a} develops the density-functional description of the many-body problem used in the calculations.
...
Appendix~\ref{cha:appendix_code} describes the source code used in this thesis.
The additional theoretical foundations and derivations supporting chapters~\ref{cha:fundamentals_a} and~\ref{cha:fundamentals_b} are collected in appendix~\ref{cha:appendix_basic}.
