...
The lattice-constant determination is shown in panel~(c) of figure~\ref{S2.1},
...
\caption[Total-energy convergence and lattice-constant scan for bulk o-\ce{B14}.]{Total-energy convergence of bulk o-\ce{B14} with respect to (a) the k-point mesh and (b) the plane-wave energy cutoff.
Here, $n_x$ is the first integer of the k-point mesh.
Panel~(c) shows the lattice-constant dependence at a plane-wave energy cutoff of \qty{600}{\electronvolt} and a k-point set of $10\times14\times9$.}
\label{S2.1}
\end{figure}
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=1.00\textwidth]{figures_proj2/S2.10.pdf}
\caption{
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.70\textwidth]{figures_proj2/S2.13.pdf}
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.70\textwidth]{figures_proj2/S2.14.pdf}
\caption{
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.75\linewidth]{figures_proj2/S2.17.pdf}
