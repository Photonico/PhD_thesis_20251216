...
a vacuum region separates the periodically repeated layers.
For pristine $\alpha$- and $\beta$-beryllene, the full supercell height is \qty{40}{\angstrom}.
...
The convergence of the dielectric function with respect to the k-point set and the total number of bands is shown in figures~\ref{fig:proj3_hcp_dielectric_nbands_convergence}--\ref{fig:proj3_cubic_dielectric_kpoint_convergence}.
...
For the pristine $\alpha$- and $\beta$-beryllene spectra discussed in section~\ref{3_optical_alpha_beta},
...
The output contains 133 bands in total, while the input requests \texttt{NBANDS=128}.
...
We therefore renormalize the calculated dielectric functions to obtain the effective dielectric response under the chosen thickness convention,
...
For $\beta$-beryllene,
the in-plane real part includes zero crossings at approximately \qty{2.24}{\electronvolt} and \qty{5.62}{\electronvolt}.
The imaginary part remains finite at these energies.
In the out-of-plane direction,
the first zero crossing occurs near \qty{4.70}{\electronvolt}.
For $\alpha$-beryllene,
the response differs,
and a higher-energy zero crossing occurs near \qty{10.64}{\electronvolt} in the out-of-plane channel,
where the imaginary part is comparatively small.
Interband transitions contribute to these spectra and also enter the inverse dielectric response.
Therefore, the zero crossings must be examined together with the imaginary part and the loss spectrum before assigning a collective excitation.
The numerical broadening used here does not determine a physical plasmon lifetime.

Within the chosen effective-medium description,
the real part also shows a strong directional contrast for $\beta$-beryllene over part of the low-energy range.
In the region of approximately \qtyrange{1.3}{2.2}{\electronvolt},
the in-plane and out-of-plane components of the real part have opposite signs.
This behaviour indicates anisotropic dielectric screening within this model;
it does not by itself establish propagating plasmonic modes in a finite layer.
...
For both structures,
the refractive index drops below one over part of the ultraviolet range.
The in-plane crossover occurs near \qty{7.4}{\electronvolt},
whereas the out-of-plane crossover occurs near \qty{7.8}{\electronvolt} for $\alpha$-beryllene and \qty{6.4}{\electronvolt} for $\beta$-beryllene.
The out-of-plane refractive index of $\alpha$-beryllene rises above one again near \qty{11.7}{\electronvolt}.
This behaviour follows from both parts of the complex dielectric function and does not by itself establish a plasmon resonance.
...
The spectra are shown for the in-plane and out-of-plane directions as functions of photon energy.
The in-plane and out-of-plane curves correspond to the $xx$ and $zz$ components, respectively.
The absorption coefficient is given in $\mathrm{nm}^{-1}$.}
...
The energy-loss spectrum of $\beta$-beryllene shows a visible-range peak and a stronger response in the deep-ultraviolet region in the in-plane channel.
By contrast,
$\alpha$-beryllene remains weak at low photon energy and rises toward the upper end of the plotted range.
In the out-of-plane channel,
both structures remain weak in the visible range and develop stronger loss features at higher energies.
The deep-ultraviolet peak of $\alpha$-beryllene is stronger than that of $\beta$-beryllene.
These spectra describe the longitudinal loss response associated with the inverse dielectric function.
...
unlike $\beta$-beryllene with its visible-range loss peak near \qty{2.4}{\electronvolt},
...
The pristine $\alpha$ and $\beta$ structures already display pronounced anisotropy and distinct longitudinal loss features.
...
The $\alpha$ and $\beta$ phases show pronounced optical anisotropy and distinct longitudinal loss features.
