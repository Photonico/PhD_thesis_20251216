...
The pristine two-dimensional outputs contain 133 bands in total, while their inputs request \texttt{NBANDS=128};
...
In the out-of-plane channel,
$\beta$-beryllene develops its strongest extinction peak near \qty{5.96}{\electronvolt}, where $k\approx4.00$, followed by weaker higher-energy features.
...
The in-plane energy-loss spectrum of $\beta$-beryllene has a visible-range local maximum of approximately 0.45
