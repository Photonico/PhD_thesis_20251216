...
(d) A crossing wholly inside the selected subspace leaves its separation from the excluded bands open.
The dashed blue curve represents $E_{2N_\mathrm{p}-2,\vec{k}}$ for $N_\mathrm{p}\geq2$; coincident partners of the two selected pairs are not drawn separately.
Orange arrows compare energies at the same wave vector; purple arrows and dotted extrema indicate the indirect separation.
Orange circles mark the contacts in (c) and (d).
...
Figure~\ref{fig:band_subspace_and_insulating_gap} separates these four situations.
...
In the fourth, both crossing pairs belong to the selected subspace on either side of the crossing.
